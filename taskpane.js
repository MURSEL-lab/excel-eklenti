...
let updateInterval2;
let updateInterval3; 
let updateInterval4; // 1500 Gün için eklendi
...
// 300 Gün için Sayfalar
const SAYFALAR = [
    "KONTROL", "P1", "P2", "P3", "P4", "P5", "P6", "P7", "P8", 
    "P9", "P10", "P11", "P12", "P13", "P14", "P15", "P16", "P17"
];

// 1500 Gün için Özel URL'ler (Sadece P sayfaları çekilecek şekilde eşleştirildi)
const URLS_1500 = [
    ...
    try {
        ...
        await Excel.run(async (context) => {
            for (let item of URLS_1500) {
                // Sayfa ismini parametre olarak gönderiyoruz, böylece KONTROL sayfası gelmez
